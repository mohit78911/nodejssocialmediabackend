...
router.update("/update/:id",(req,res)=>{
  likes.updateOne({_id :req.params.id},{$set:{like:req.body.like}}).then((result)=>{res.status(200).json(result) console.log("updateSuccessfully")}).catch((error)=>{console.log()})
})
